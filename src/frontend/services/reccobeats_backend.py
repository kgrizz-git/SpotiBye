...
class ReccoBeatsBackendService:
    ...
    def analyze_playlist(self, playlist_id: str, analysis_task: Optional[Any] = None) -> Dict[str, Any]:
        """
    ...
    def _poll_analysis_completion(self, job_id: str, playlist_id: str, 
        ...
        while time.time() - start_time < max_wait_time:
            ...
            try:
                ...
                if status == 'completed':
                    ...
                    if analysis_task:
                        analysis_task.update_progress(progress, f"Analyzing playlist... {progress}%")
    ...
    @handle_network_errors
    def get_playlist_for_analysis(self, playlist_id: str, analysis_task: Optional[Any] = None) -> Dict[str, Any]:
        """
    ...
    def get_multiple_track_audio_features_safe(
        ...
        try:
            ...
            logger.info(f"Found {cached_count} cached tracks, fetching {len(uncached_tracks)} uncached tracks")
            ...
            logger.warning("Individual track analysis not supported in backend mode - requires playlist analysis")
    ...
    def get_audio_features_by_reccobeats_id(
        ...
        """
        logger.debug("get_audio_features_by_reccobeats_id not supported in backend mode")
        return {}
...
__all__ = ["ReccoBeatsBackendService", "ReccoBeatsAPI", "get_reccobeats_service", "get_reccobeats_api"]
