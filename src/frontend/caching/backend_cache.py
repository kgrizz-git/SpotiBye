...
from ..config.backend_config import CACHE_DIR, TOKEN_CACHE_PATH, FeatureFlags
...
class BackendCacheManager:
    ...
    def cache_tracks(self, playlist_id: str, tracks: List[Dict[str, Any]], ttl: int = 7200) -> None:
        """
    ...
    def cache_analysis(self, playlist_id: str, analysis: Dict[str, Any], ttl: int = 86400) -> None:
        """
    ...
    def cache_export_info(self, playlist_id: str, export_info: Dict[str, Any], ttl: int = 3600) -> None:
        """
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.token_cache_path.exists():
                ...
                if not stats['last_updated'] or self.token_cache_path.stat().st_mtime > stats['last_updated']:
