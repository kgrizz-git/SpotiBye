...
try:
    ...
    from ..screens.cache_explorer_adapter import CacheExplorerAdapter, create_cache_explorer
...
class TestBackendCacheExplorer(unittest.TestCase):
    ...
    def test_backend_cache_explorer_initialization(self, mock_client_class, mock_config_class):
    ...
    def test_backend_cache_explorer_no_backend(self, mock_config_class):
        ...
        self.assertFalse(explorer.backend_switch.active if explorer.backend_switch else True)

    def test_backend_cache_status_display(self):
        """Test backend cache status display update."""
        with patch('src.frontend.ui.backend_cache_explorer.BackendConfig') as mock_config_class, \
             patch('src.frontend.ui.backend_cache_explorer.BackendClient') as mock_client_class:
            
            mock_config_class.return_value = self.mock_config
            mock_client_class.return_value = self.mock_client
            
            explorer = BackendCacheExplorerPopup()
            explorer.backend_cache_status = self.mock_client.get_cache_status.return_value
    ...
    def test_backend_details_popup(self):
        ...
        with patch('src.frontend.ui.backend_cache_explorer.BackendConfig') as mock_config_class, \
             patch('src.frontend.ui.backend_cache_explorer.BackendClient') as mock_client_class, \
             patch('src.frontend.ui.backend_cache_explorer.Popup') as mock_popup_class:
...
class TestCacheExplorerAdapter(unittest.TestCase):
    ...
    def test_adapter_cache_status_info(self):
        ...
        with patch('src.frontend.screens.cache_explorer_adapter.BackendConfig') as mock_config:
