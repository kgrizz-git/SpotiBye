...
class TestCacheExplorerMock(unittest.TestCase):
    ...
    def test_backend_cache_explorer_mock_creation(self, mock_switch, mock_label, mock_layout, mock_popup):
        ...
        with patch.dict('sys.modules', {
            ...
            mock_backend_explorer.BackendCacheExplorerPopup.return_value = self.mock_popup
    ...
    def test_cache_status_data_structure(self):
        ...
        expected_hit_rate = (cache_status['cache_hits'] / cache_status['total_requests']) * 100
    ...
    def test_cache_status_display_formatting(self):
        ...
        expected_text = f'Backend: {hit_rate:.1f}% hit rate, {cache_size:.1f}MB/{max_size:.1f}MB'
    ...
    def test_error_handling_scenarios(self):
        ...
        status_text = 'Backend: Disabled' if not backend_enabled else 'Backend: Connected'
