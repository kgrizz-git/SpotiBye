...
import pytest
from src.frontend.screens.main_screen_sort_filter import filter_playlists, sort_playlists

@pytest.fixture
def playlists():
    return [
        {"id": "1", "name": "Rock Classics", "owner": {"display_name": "Alice"}, "tracks": {"total": 50}},
        {"id": "2", "name": "Jazz Night", "owner": {"display_name": "Bob"}, "tracks": {"total": 20}},
        {"id": "3", "name": "Classical Focus", "owner": {"display_name": "Alice"}, "tracks": {"total": 100}},
    ]
