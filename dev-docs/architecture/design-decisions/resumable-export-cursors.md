...
**Status:** Implemented
**Date:** 2025
**Full plan:** [`../../exec-plans/completed/legacy/resumable-export-cursor-persistence-plan.md`](../../exec-plans/completed/legacy/resumable-export-cursor-persistence-plan.md)
