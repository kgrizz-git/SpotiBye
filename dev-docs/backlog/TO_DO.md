...
- [ ] Wire popup close to `AnalysisTask.cancel()` (progress-plan optional follow-up; poll loop already honors `is_cancelled()`; backend job keeps running — document; needs CHANGELOG + tests)
