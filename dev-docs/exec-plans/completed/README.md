...
| [`2026-07-11-backend-playlist-analysis-progress-bar.md`](2026-07-11-backend-playlist-analysis-progress-bar.md) | In-app progress bar for playlist analysis: granular ReccoBeats progress band, AnalysisTask UI wiring, Durable Object live status, data-coverage hardening, and dismiss-cancels-polling. Verified by suite + live dev trace (NPR playlist). | 2026-09-19 |
| [`2026-09-19-analysis-fanout-queue.md`](2026-09-19-analysis-fanout-queue.md) | Large-playlist analysis fan-out: distributed per-batch queue messages with DO countdown + atomic finalizer claim, stuck-job backstop, force-flag split, monotonic merged progress, self-rescheduling orphan alarm. Verified by 934-test suite (96 files, re-run 2026-09-20) + live dev trace (NPR playlist, single job, 22s, zero subrequest errors; upstream coverage best-effort: meta 18/27, gaps in `errors[]`). | 2026-09-20 |
