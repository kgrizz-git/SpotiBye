...
<!-- Describe the change and its motivation in 2-3 sentences. -->
...
- [ ] No new `console.log` in backend non-test code (use structured logging)
- [ ] No bare `except:` added in Python code
