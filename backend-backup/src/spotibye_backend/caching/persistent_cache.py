...
class PersistentCache:
    ...
    def _load_metadata(self) -> dict[str, Any]:
        try:
            if self.metadata_file.exists():
                with open(self.metadata_file, encoding="utf-8") as file:
    ...
    # Helpers
    # ------------------------------------------------------------------
    def _get_cache_key(self, playlist_id: str, user_id: str | None = None) -> str:
    ...
    # Image cache
    # ------------------------------------------------------------------
    def cache_image(self, image_url: str, image_data: bytes) -> str | None:
        try:
    ...
    def _optimize_image(self, image_data: bytes, image_url: str) -> bytes | None:
        ...
        try:
            ...
            )  # method=6 for better compression
    ...
    def get_cached_image_path(self, image_url: str) -> str | None:
        try:
            url_hash = hashlib.md5(image_url.encode()).hexdigest()
    ...
    def get_cached_track_reccobeats(self, spotify_id: str) -> dict[str, Any] | None:
