...
class ReccoBeatsAPI:
    ...
    def get_reccobeats_id_from_spotify_id(
        ...
        try:
            ...
            response = self.session.get(url, params=params, timeout=settings.RECCOBEATS_TIMEOUT)
            ...
            for i in range(0, len(spotify_ids), batch_size):
                ...
                with concurrent.futures.ThreadPoolExecutor(max_workers=max_concurrent) as executor:
                    ...
                    for future in concurrent.futures.as_completed(future_to_track):
                        ...
                        try:
                            spotify_id, features = future.result(timeout=settings.RECCOBEATS_TIMEOUT * 3)
                            if features:
