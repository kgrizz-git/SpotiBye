...
class TestPerformance:
    ...
    def test_health_check_performance(
        self, client: Any, performance_monitor: Any
    ) -> None:
    ...
    def test_auth_verification_performance(
        self, client: Any, auth_headers: dict[str, str], performance_monitor: Any
    ) -> None:
    ...
    def test_response_size_performance(self, client: Any) -> None:
        ...
        endpoints = ["/health", "/auth/verify", "/openapi.json"]
...
class TestLoadTesting:
    ...
    def test_memory_leak_detection(self, client: Any) -> None:
        ...
        )  # Less than 20MB growth after 1000 requests
