...
| [2026-06-21 Repo organization & guardrails](2026-06-21-repo-organization-guardrails.md) | Consolidate plans, remove duplicate agent config, create CLAUDE.md, add pre-commit structural hook. | 2026-06-21 |
