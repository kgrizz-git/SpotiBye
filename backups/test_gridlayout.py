...
class GridLayoutTestApp(App):
    def build(self):
        ...
        test1_label = Label(text='Test 1: GridLayout cols=4, only 1 widget', size_hint_y=None, height=30)
        ...
        test2_label = Label(text='Test 2: GridLayout cols=4, 2 widgets', size_hint_y=None, height=30)
        ...
        test3_label = Label(text='Test 3: GridLayout cols=4, 4 widgets (full)', size_hint_y=None, height=30)
        ...
        colors = [(0.8, 0.3, 0.3, 1), (0.3, 0.8, 0.3, 1), (0.3, 0.3, 0.8, 1), (0.8, 0.8, 0.3, 1)]
        ...
        test4_label = Label(text='Test 4: 1 visible + 3 opacity=0 widgets', size_hint_y=None, height=30)
