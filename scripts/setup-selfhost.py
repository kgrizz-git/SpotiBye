...
def _dotenv_quote(value: str) -> str:
    """Quote a value for dotenv double-quoted syntax."""
...
def build_dev_vars_content(
    ...
    lines = [
        ...
        f"SPOTIFY_CLIENT_ID={_dotenv_quote(client_id)}",
        f"SPOTIFY_CLIENT_SECRET={_dotenv_quote(client_secret)}",
        f"JWT_SECRET={_dotenv_quote(jwt_secret)}",
        "",
    ]
    return "\n".join(lines)
