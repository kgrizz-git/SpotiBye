...
### Added
- Analysis popup shows an informational **Enrichment: N/M tracks** status line with last-refreshed time; **Refresh playlist tracks** and **Refresh track info** buttons force-refresh Spotify membership or per-track ReccoBeats enrichment before TTL expiry. Tracks popup includes **Refresh playlist tracks** only.
